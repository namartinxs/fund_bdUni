...
INSERT INTO Funcionario (Cod_Func,Nome_Func, Data_CadFunc, Sexo_Func, Sal_Func, End_Func) VALUES
(1,'Antonio Antonino Antones', STR_TO_DATE('01/02/00', '%d/%m/%y'), 'M', 1500.00, 'Rua A'),
(2,'Amaro Merico Vespucio', STR_TO_DATE('02/02/00', '%d/%m/%y'), 'M', 2500.00, 'Rua B'),
(3,'Abílio Abel Garcia', STR_TO_DATE('03/02/01', '%d/%m/%y'), 'M', 1000.00, 'Rua C'),
(4,'Bia Bianca Bones', STR_TO_DATE('04/03/01', '%d/%m/%y'), 'F', 5000.25, 'Rua D'),
(5,'Beatriz Bertioga', STR_TO_DATE('05/05/01', '%d/%m/%y'), 'F', 300.00, 'Rua E'),
(6,'Caio Cesar Cearez', STR_TO_DATE('06/05/01', '%d/%m/%y'), 'M', 250.00, 'Rua F'),
(7,'Celso Cesare', STR_TO_DATE('07/06/01', '%d/%m/%y'), 'M', 1542.36, 'Rua J'),
(8,'Danilo Douglas', STR_TO_DATE('08/06/01', '%d/%m/%y'), 'M', 1524.56, 'Rua K'),
(9,'Denis Denilo', STR_TO_DATE('09/07/01', '%d/%m/%y'), 'M', 5235.56, 'Rua L'),
(10,'Everton Evaristo', STR_TO_DATE('10/07/01', '%d/%m/%y'), 'M', 2542.25, 'Rua M'),
(11,'Evanir Eva', STR_TO_DATE('11/08/01', '%d/%m/%y'), 'M', 4523.54, 'Rua N'),
(12,'Fabio Fabricio', STR_TO_DATE('12/08/01', '%d/%m/%y'), 'M', 1524.25, 'Rua O'),
(13,'Fabiola Fabiolo', STR_TO_DATE('02/01/02', '%d/%m/%y'), 'F', 2554.25, 'Rua P'),
(14,'Geraldo Gomes', STR_TO_DATE('03/10/02', '%d/%m/%y'), 'M', 1542.25, 'Rua Q'),
(15,'Helio Heliópolis', STR_TO_DATE('04/01/02', '%d/%m/%y'), 'M', 1542.23, 'Rua R'),
(16,'Irineu Irene', STR_TO_DATE('05/02/02', '%d/%m/%y'), 'M', 2523.00, 'Rua S'),
(17,'Jonas Jackes', STR_TO_DATE('05/02/02', '%d/%m/%y'), 'M', 2500.00, 'Rua T'),
(18,'Leandro Lago', STR_TO_DATE('06/02/02', '%d/%m/%y'), 'M', 1500.00, 'Rua U'),
(19,'Lucio Lacio', STR_TO_DATE('07/03/02', '%d/%m/%y'), 'M', 2500.00, 'Rua V'),
(20,'Lecio Licio', STR_TO_DATE('08/04/02', '%d/%m/%y'), 'M', 1420.00, 'Rua X'),
(21,'Mario Mendes', STR_TO_DATE('06/02/02', '%d/%m/%y'), 'M', 1262.00, 'Rua W'),
(22,'Olavo Odavlas', STR_TO_DATE('07/07/02', '%d/%m/%y'), 'M', 1540.00, 'Rua Y');
...
CREATE PROCEDURE P_GeraDadosBonus(IN Val_Bonus DECIMAL(10,2))
BEGIN
  ...
  read_loop: LOOP
    FETCH Cursor_Funcionario INTO Cod_Func;

    IF done THEN
      LEAVE read_loop;
    END IF;

    -- Inserção na tabela Bonus
    INSERT INTO Bonus (Cod_Func, Data_Bonus, Val_Bonus)
    VALUES (Cod_Func, CURRENT_DATE - INTERVAL 30 DAY, Val_Bonus);
